...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    async function loadDashboardData() {
      try {
        const [statsData, categoryData, statusData, monthData] = await Promise.all([
    ...
    <div className="container py-5">
      <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start gap-3 mb-4">
        <div>
          ...
          <h1 className="h2 fw-bold text-dark mb-2">Panoramica delle segnalazioni</h1>
          <p className="text-secondary mb-0">
            Monitora rapidamente lo stato complessivo delle pratiche e l’evoluzione nel tempo.
          </p>
        </div>
          ...
          <div className="card border-0 shadow-sm h-100" style={{ borderRadius: 16 }}>
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <div>
                  <h2 className="h5 fw-bold mb-1">Segnalazioni per categoria</h2>
                  <p className="text-secondary mb-0 small">Distribuzione delle pratiche per tipologia</p>
                </div>
              </div>
            ...
            <div className="card-body p-4">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <div>
                  ...
                  <p className="text-secondary mb-0 small">Quota attuale per ciascuno stato</p>
                </div>
              </div>
        ...
        <div className="card-body p-4">
          <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start gap-3 mb-3">
            <div>
              ...
              <p className="text-secondary mb-0 small">Trend mensile delle pratiche ricevute</p>
            </div>
            <div className="d-flex flex-wrap gap-2">
              <div className="text-muted small">
                Tempo medio di chiusura: {stats.averageResolutionHours.toFixed(1)} ore
              </div>
              <a href="/dashboard/reports" className="btn btn-sm btn-outline-primary">
